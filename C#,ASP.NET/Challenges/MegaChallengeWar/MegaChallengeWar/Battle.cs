    ...
    public class Battle
    {
        ...
        private void performEvaluation(Player player1, Player player2, Card card1, Card card2)
        {
            ...
            if (card1.CardValue() == card2.CardValue())
                war(player1, player2);
            if (card1.CardValue() > card2.CardValue())
                bountyWinner(player1);
            else
                bountyWinner(player2);
        }

        private void bountyWinner(Player player)
        {
            ...
            displayBountyWinner(player);
        }

        private void war(Player player1, Player player2)
        {
            _sb.Append("<br/><br/>***************IT IS WARTIME!!!***************<br/><br/>");
            getCard(player1);
            getCard(player1);
            getCard(player1);
        ...
        private void displayBattleCards(Card card1, Card card2)
        {
            ...
            _sb.Append(card1.Color);
            _sb.Append(" vs. ");
            _sb.Append(card2.Kind);
            _sb.Append(card2.Color);
        }
        ...
        private void displayBountyWinner(Player player)
        {
