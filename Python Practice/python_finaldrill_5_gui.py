...
def load_gui(self):
    ...
    self.lbl_browse1.grid(row=3,column=0,padx=(1,1),pady=(1,1),sticky=N+E+S+W)
    
    self.txt_lastCheck = tk.Entry(self.master,text='')
    self.txt_lastCheck.grid(row=3,column=1,padx=(1,1),pady=(1,1),sticky=N+E+S+W)
    ...
    self.btn_exit.grid(row=4,column=0,columnspan=2,padx=(1,1),pady=(1,1),sticky=N+E+S+W)
